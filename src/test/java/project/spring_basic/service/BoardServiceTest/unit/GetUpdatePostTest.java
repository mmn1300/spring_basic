...
public class GetUpdatePostTest extends BoardServiceUnitTestSupport {
    
    @Test
    @DisplayName("유효하지 않은 입력에 대한 예외를 발생시킨다.")
    public void getUpdatePostArgumentException() throws Exception {
        assertThatThrownBy(() -> boardService.getUpdatePost(0L))
    ...
    public void getUpdateostException() throws Exception {
        // given
